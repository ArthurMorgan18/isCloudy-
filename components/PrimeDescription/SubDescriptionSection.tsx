    ...
    return (
        <View style={styles.subDescContainer}>
            <View style={styles.subDescItem}>
                ...
                <Text style={{color:theme.input.textColor}}>{Math.round(currentWeatherState.main.temp_max)} C°</Text>
            </View>
            <View style={styles.subDescItem}>
                <Text style={{color:theme.input.textColor}}>MIN: </Text>
                <Text style={{color:theme.input.textColor}}>{Math.round(currentWeatherState.main.temp_min)} C°</Text>
            </View>
        </View>
    )
};
